...
export const products: Product[] = [
  ...
  */
  ...
  },
  {
    ...
    price: 82,
    image: '/products/1.png',
    position: { top: 'calc(108% - 96px)', left: '2%' },
    mobilePosition: { top: 'calc(100% - 70px)', left: '5%' },
    rotation: -6,
    scale: 0.9,
    zIndex: 4,
    category: 'bottom'
  },
  {
    ...
    price: 32,
    image: '/products/5.png',
    position: { top: 'calc(115% - 96px)', left: '18%' },
    mobilePosition: { top: 'calc(100% - 70px)', left: '38%' },
    rotation: 20,
    scale: 0.78,
    zIndex: 8,
    category: 'accessory'
  ...
  {
    id: '21',
    name: 'Navy 80564 Hoodie',
    price: 128,
    image: '/products/9.png',
    position: { top: 'calc(105% - 96px)', left: '34%' },
    mobilePosition: { top: 'calc(100% - 70px)', left: '71%' },
    rotation: -4,
    scale: 0.97,
    zIndex: 6,
    category: 'top'
  },
  {
    ...
    price: 48,
    image: '/products/11.png',
    position: { top: 'calc(112% - 96px)', left: '50%' },
    mobilePosition: { top: 'calc(115% - 70px)', left: '5%' },
    rotation: 9,
    scale: 0.89,
    zIndex: 3,
    category: 'top'
  },
  {
    ...
    price: 44,
    image: '/products/12.png',
    position: { top: 'calc(107% - 96px)', left: '66%' },
    mobilePosition: { top: 'calc(115% - 70px)', left: '38%' },
    rotation: -40,
    scale: 0.72,
    zIndex: 9,
    category: 'accessory'
  },
  {
    ...
    price: 70,
    image: '/products/13.png',
    position: { top: 'calc(107% - 96px)', left: '82%' },
    mobilePosition: { top: 'calc(115% - 70px)', left: '71%' },
    rotation: 6,
    scale: 0.86,
    zIndex: 5,
    category: 'bottom'
  },
  {
    ...
    price: 32,
    image: '/products/14.png',
    position: { top: 'calc(136% - 96px)', left: '8%' },
    mobilePosition: { top: 'calc(130% - 70px)', left: '5%' },
    rotation: 18,
    scale: 0.8,
    zIndex: 7,
    category: 'accessory'
  ...
  {
    id: '26',
    name: 'Sage Green Long Sleeve',
    price: 88,
    image: '/products/15.png',
    position: { top: 'calc(140% - 96px)', left: '24%' },
    mobilePosition: { top: 'calc(130% - 70px)', left: '38%' },
    rotation: -9,
    scale: 0.95,
    zIndex: 4,
    category: 'top'
  },
  {
    ...
    price: 74,
    image: '/products/16.png',
    position: { top: 'calc(148% - 96px)', left: '40%' },
    mobilePosition: { top: 'calc(130% - 70px)', left: '71%' },
    rotation: 11,
    scale: 0.91,
    zIndex: 3,
    category: 'bottom'
  ...
  {
    id: '28',
    name: 'Maroon 80564 T-Shirt',
    price: 45,
    image: '/products/17.png',
    position: { top: 'calc(142% - 96px)', left: '56%' },
    mobilePosition: { top: 'calc(145% - 70px)', left: '5%' },
    rotation: -2,
    scale: 0.93,
    zIndex: 5,
    category: 'top',
  ...
  },
  {
    ...
    price: 55,
    image: '/products/20.png',
    position: { top: 'calc(142% - 96px)', left: '72%' },
    mobilePosition: { top: 'calc(145% - 70px)', left: '38%' },
    rotation: 28,
    scale: 0.83,
    zIndex: 8,
    category: 'accessory'
  },
  {
    ...
    price: 76,
    image: '/products/21.png',
    position: { top: 'calc(142% - 96px)', left: '88%' },
    mobilePosition: { top: 'calc(145% - 70px)', left: '71%' },
    rotation: -14,
    scale: 0.87,
    zIndex: 4,
    category: 'bottom'
  ...
  {
    id: '31',
    name: 'Ivory Ringer Tee',
    price: 56,
    image: '/products/22.png',
    position: { top: 'calc(169% - 96px)', left: '4%' },
    mobilePosition: { top: 'calc(160% - 70px)', left: '5%' },
    rotation: 3,
    scale: 0.94,
    zIndex: 5,
    category: 'top'
  },
  {
    ...
    price: 28,
    image: '/products/27.png',
    position: { top: 'calc(173% - 96px)', left: '20%' },
    mobilePosition: { top: 'calc(160% - 70px)', left: '38%' },
    rotation: -30,
    scale: 0.68,
    zIndex: 9,
    category: 'accessory'
  },
  {
    ...
    price: 118,
    image: '/products/33.png',
    position: { top: 'calc(167% - 96px)', left: '36%' },
    mobilePosition: { top: 'calc(160% - 70px)', left: '71%' },
    rotation: -5,
    scale: 0.99,
    zIndex: 6,
    category: 'top'
  ...
  {
    id: '34',
    name: 'Burgundy Plaid Shorts',
    price: 72,
    image: '/products/34.png',
    position: { top: 'calc(175% - 96px)', left: '52%' },
    mobilePosition: { top: 'calc(175% - 70px)', left: '5%' },
    rotation: -11,
    scale: 0.9,
    zIndex: 3,
    category: 'bottom'
  ...
  {
    id: '35',
    name: 'Blue 80564 Hoodie',
    price: 128,
    image: '/products/35.png',
    position: { top: 'calc(171% - 96px)', left: '68%' },
    mobilePosition: { top: 'calc(175% - 70px)', left: '38%' },
    rotation: 7,
    scale: 0.96,
    zIndex: 6,
    category: 'top'
  },
  {
    ...
    price: 38,
    image: '/products/36.png',
    position: { top: 'calc(171% - 96px)', left: '84%' },
    mobilePosition: { top: 'calc(175% - 70px)', left: '71%' },
    rotation: 42,
    scale: 0.71,
    zIndex: 9,
    category: 'accessory'
  ...
  {
    id: '37',
    name: 'Forest Green Cargo Pants',
    price: 84,
    image: '/products/37.png',
    position: { top: 'calc(201% - 96px)', left: '2%' },
    mobilePosition: { top: 'calc(190% - 70px)', left: '5%' },
    rotation: -7,
    scale: 0.92,
    zIndex: 4,
    category: 'bottom'
  },
  {
    ...
    price: 96,
    image: '/products/38.png',
    position: { top: 'calc(208% - 96px)', left: '18%' },
    mobilePosition: { top: 'calc(190% - 70px)', left: '38%' },
    rotation: 13,
    scale: 0.85,
    zIndex: 5,
    category: 'top'
  },
  {
    ...
    price: 36,
    image: '/products/39.png',
    position: { top: 'calc(198% - 96px)', left: '34%' },
    mobilePosition: { top: 'calc(190% - 70px)', left: '71%' },
    rotation: -22,
    scale: 0.79,
    zIndex: 8,
    category: 'accessory',
  ...
  {
    id: '40',
    name: 'Rust Corduroy Shorts',
    price: 69,
    image: '/products/40.png',
    position: { top: 'calc(205% - 96px)', left: '50%' },
    mobilePosition: { top: 'calc(205% - 70px)', left: '5%' },
    rotation: 5,
    scale: 0.88,
    zIndex: 3,
    category: 'bottom'
